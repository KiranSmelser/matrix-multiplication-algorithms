...
public class StrassensMatrixMultiplicationTest {
    ...
    public static void main(String[] args) {
        ...
        for (int size = 2; size <= maxMatrixSize; size *= 2) {
            ...
            int[][] result = StrassensMatrixMultiplication.multiply_matrix(A, B);
            ...
            System.out.println("Strassen's runtime (nanoseconds): " + (endTime - startTime));
